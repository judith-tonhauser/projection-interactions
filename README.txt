...
*output: Talk slides based on the experiments, and the aforementioned paper
...
The folder /results/exp1/rscripts also includes a comparison of the beta models to ZOIB models (ZOIB-comparison) as well as auxiliary analyses were individual projection ratings are predicted from mean at-issueness and (mean vs. individual-level) prior ratings. These were not reported in the paper.
