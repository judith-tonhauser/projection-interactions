...
//         $(".err").hide(); 
  ...
  slides.instructions2 = slide({
    ...
    start : function() {
    $('.bar').css('width', ( (100*(exp.phase)/exp.nQs) + "%"));    	    	
    	var inst2 = "That was the second of the three parts! ";
...
// decide which block of ai and projective comes first after prior block
  var block_order = _.shuffle(["ai","projective"]);
  var block1type = block_order[0];
  var block2type = block_order[1];  
  var block0type = "prior";
  // console.log(block_order);
  //console.log(block0type);  
...
//		}
  ...
  exp.structure=["botcaptcha", "i0", "instructions","instructions0","block0","instructions1", "block1", "instructions2", "block2", 'questionaire', 'finished'];
